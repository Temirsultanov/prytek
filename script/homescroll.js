...
var onScrollFunc = function () {
    if (pageYOffset >= 800 && pageYOffset < 1000) {
        var x = 1000 - pageYOffset;
        var percent =  Math.floor(x * 100 / 200);
    ...
    if (pageYOffset >= 1100 && pageYOffset < 1200) {
        var z = 1200 - pageYOffset;
    ...
    if (pageYOffset >= 2100 && pageYOffset < 2400) {
        var k = (2400 - pageYOffset) / 3;
